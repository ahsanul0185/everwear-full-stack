...
const PlaceOrder = () => {
  ...
  return (
    <form onSubmit={onSubmitHandles} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t section-padding'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            <div onClick={() => setMethod('stripe')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              <p className={`size-3 border rounded-full  ${method === "stripe" ? "bg-green-600" : "bg-transparent"}`}></p>
              <img src={assets.stripe_logo} className='h-5 mx-4' alt="" />
            </div>

            <div onClick={() => setMethod('razorpay')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              <p className={`size-3 border rounded-full  ${method === "razorpay" ? "bg-green-600" : "bg-transparent"}`}></p>
              <img src={assets.razorpay_logo} className='h-5 mx-4' alt="" />
            </div>

            <div onClick={() => setMethod('cod')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              <p className={`size-3 border rounded-full  ${method === "cod" ? "bg-green-600" : "bg-transparent"}`}></p>
